...
class MSL_PF_Tracker:
    ...
    def observe(self, img):
        ...
        self.weights[:] = [hist(cand, self.model, std=10,num_bins=8) for cand in candidates]
    ...
    def resample(self):
        ...
        distrib = self.weights.flatten() #Sample new particle indices using the distribution of the weights
